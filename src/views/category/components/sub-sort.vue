<template>
  <div class="sub-sort">
    ...
    <div class="check">
      <ShopCheckbox @change="changeCheck" v-model="sortParams.inventory"
        >仅显示有货商品</ShopCheckbox
      >
      <ShopCheckbox @change="changeCheck" v-model="sortParams.onlyDiscount"
        >仅显示特惠商品</ShopCheckbox
      >
    </div>
  </div>
</template>
